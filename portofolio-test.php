			...
			<div class="row">
				<div class="heading">
					<div class="col-md-3 col-sm-12">
						<span>Portofolio Test</span>
						<h3>Kisah <br>Sukses.</h3>
					</div>
					<div class="col-md-9 col-sm-12">
						<p>Mendukung terlaksananya Good Governance di Dunia Pendidikan adalah misi kami, berikut ini
							adalah
							success story atau buah kerja keras SEVIMA selama 14 tahun kami melayani berbagai institusi
							dan
		...
		<div class="container">
			<div class="row">
				<div class="heading">
					...
					<div class="col-md-9 col-sm-12">
						<p>Kami membantu perguruan tinggi atau universitas menciptakan pengalaman digital yang
						...
						<ul class="nav nav-pills">
			              ...
			              ?>
							...
							<li class="nav-item"><a class="nav-link" href="#<?php echo $term->slug; ?>"
									data-toggle="tab" style="text-transform: capitalize"><?php echo $term->name; ?></a>
							</li>
							<?php } ?>
							<?php endif;?>
						</ul>

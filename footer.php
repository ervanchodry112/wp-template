<!--<div class="footer-alert">
  <div class="alert alert-warning alert-dismissible fade show" id="multiCollapseExample1" role="alert">
    <strong>Dapatkan Sistem Informasi Pengelolaan Kampus Terintegrasi: </strong> <a href="https://siakadcloud.com/#utm_source=website_sevima&utm_medium=floating_footer&utm_campaign=floatingsiakadcloud&utm_content=organic"
      class="link-alert" target="_blank"> Klik Disini!</a>
    ...
    <div class="row">
      <div class="col-sm-12 col-md-5 col-lg-3 footer-location">
        <div class="pattern-border">
          <img src="<?php echo get_template_directory_uri(); ?>/img/logo-sevima-putih.png" alt="">
        </div>
      ...
      <div class="col-sm-12 col-md-7 col-lg-9 footer-list">
        ...
        <div class="row bottom-footer">
          ...
          <div class="col-12 col-lg-6 icon-medsos">
            ...
            <a href="https://www.youtube.com/channel/UCDcvqZbhsdaDCnmUURz54uw" target="_blank">
              <img src="<?php echo get_template_directory_uri(); ?>/img/youtube.png" alt="">
            </a>
            <a href="https://twitter.com/sevima_official/" target="_blank">
              <img src="<?php echo get_template_directory_uri(); ?>/img/twitter.png" alt="">
            </a>
            <a href="https://www.instagram.com/sevima_official/" target="_blank">
              <img src="<?php echo get_template_directory_uri(); ?>/img/instagram.png" alt="">
            </a>
            <a href="https://www.linkedin.com/company/sevima" target="_blank">
...
<!-- <script defer src="<?php echo content_url(); ?>/cache/minify/8c99d.js"></script>
<script defer src="<?php echo content_url(); ?>/cache/minify/cdbef.js"></script> -->
<script src="<?php echo get_template_directory_uri(); ?>/owlcarousel/owl.carousel.js"></script>

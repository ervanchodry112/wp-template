                ...
                <div class="col-md-12">
                    <div class="left-content align-items-center">
                        ...
                        <div style="margin-left:24px;">
                            <?php echo do_shortcode('[ivory-search id="7" title="Default Search Form"]'); ?>
                        </div>
                    </div>
            ...
            <nav class="navbar navbar-expand-lg">
                ...
                <div class="collapse navbar-collapse-sevima" id="navbar-sevima">
                    <div class="container navbar-480">
                        ...
                        <div class="navigation-res">
                            ...
                            <ul>
                                <li><a href="#" class="produk-click-3">Tentang <i class="uil uil-angle-right"></i></a></li>
                                ...
                                <li><a href="<?php echo home_url(); ?>/harga/">Harga </a></li>
                                <li><a href="<?php echo home_url(); ?>/event-sevima/">Event</a></li>
                                <li><a href="#" class="produk-click-1">Pusat Info <i class="uil uil-angle-right"></i></a></li>
                            </ul>
                            ...
                            <a href="https://klikwa.net/sevima" aria-label="Kontak WA">
                ...
                <div class="navbar-collapse-sevima-1" id="navbar-sevima-1">
                    <div class="container navbar-480">
                        ...
                        <div class="navigation-res">
                            <ul>
                                <li><a href="<?php echo home_url(); ?>/regulasi/">Regulasi Pendidikan Tinggi</a></li>
                                <li><a href="<?php echo home_url(); ?>/akreditasi/">Akreditasi</a></li>
                                <li><a href="<?php echo home_url(); ?>/studi-kasus/">Studi Kasus</a></li>
                                <li><a href="<?php echo home_url(); ?>/ebook/">Ebook</a></li>
                                <li><a href="<?php echo home_url(); ?>/siaran-pers/">Siaran Pers</a></li>
                                <li><a href="<?php echo home_url(); ?>/video/">Video</a></li>
                                <li><a href="<?php echo home_url(); ?>/artikel-blog/">Blog</a></li>
                                <li><a target="_blank" href="https://help.sevima.com/">SEVIMA Care</a></li>
                            </ul>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="container navbar-480">
                        ...
                        <div class="navigation-res">
                            <ul>
                                ...
                                <li><a href="<?php echo home_url(); ?>/karir/">Pusat Karier</a></li>
                                <li><a href="<?php echo home_url(); ?>/revolutionize-education/">#revolutionizeEducation</a></li>
                            </ul>
                        </div>
                    </div>
                </div>
                ...
                <div class="collapse navbar-collapse">
                    <ul class="navbar-nav ml-auto mr-auto">
                        <li class="nav-item dropdown" style="position: dynamic;">
                            <a class="nav-link dropdown-toggle" data-toggle="dropdown" href="#">Tentang</a>
                            <div class="dropdown-menu" style="top: 2.1rem;">
                                <a class="dropdown-item" href="<?php echo home_url(); ?>/tentang/">Tentang Kami</a>
                                <a class="dropdown-item" href="<?php echo home_url(); ?>/karir/">Pusat Karier</a>
                                <a class="dropdown-item" href="<?php echo home_url(); ?>/revolutionize-education/">#revolutionizeEducation</a>
                            </div>
                        </li>
                        ...
                        <li class="nav-item">
                            <a class="nav-link" href="<?php echo home_url(); ?>/harga/"></i>Harga</a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link" href="<?php echo home_url(); ?>/event-sevima/"></i>Event</a>
                        </li>
                        <li class="nav-item dropdown">
                            <a class="nav-link dropdown-toggle" data-toggle="dropdown" href="#">Pusat Info</a>
                            <div class="dropdown-menu" style="top: 2.3rem;">
                                <a class="dropdown-item" href="<?php echo home_url(); ?>/regulasi/">Regulasi Pendidikan Tinggi</a>
                                <a class="dropdown-item" href="<?php echo home_url(); ?>/akreditasi/">Akreditasi</a>
                                <a class="dropdown-item" href="<?php echo home_url(); ?>/studi-kasus/">Studi Kasus</a>
                                <a class="dropdown-item" href="<?php echo home_url(); ?>/ebook/">Ebook</a>
                                <a class="dropdown-item" href="<?php echo home_url(); ?>/siaran-pers/">Siaran Pers</a>
                                <a class="dropdown-item" href="<?php echo home_url(); ?>/video/">Video</a>
                                <a class="dropdown-item" href="<?php echo home_url(); ?>/artikel-blog/">Blog</a>
                                <a class="dropdown-item" target="_blank" href="https://help.sevima.com/">SEVIMA Care</a>
                            </div>
                        </li>
                        <!-- <li class="nav-item">
                ...
                <div class="navbar-right ml-auto hide-xs">
                    ...
                    <div class="icons">
                        ...
                        <a href="https://klikwa.net/sevima" target="_blank" aria-label="Kontak WA"><img src="<?php echo get_template_directory_uri(); ?>/img/whatsapp.png" class="img-fluid gbr-icon" alt=""> </a>
                    </div>
                </div>
            </nav>
        </div>

...
<section id="kontak-kami">
    <div class="container">
        <div class="row">
            ...
            <div class="col-lg-12 col-12 order-first order-md-last">
                <div class="kontak-kami">
                    <h3 class="wow fadeInUp" data-wow-delay="0.1s">Form Mahasiswa</h3>
                    <div class="border-red wow fadeInUp" data-wow-delay="0.150s"></div>
                    <p class="wow fadeInUp" data-wow-delay="0.170s">Silahkan isi form berikut untuk mengetahui solusi yang tepat mengenai permasalahan Anda.
                    </p>
                    ...
                    <?php echo do_shortcode( '[contact-form-7 id="12073" title="Form-mahasiswa"]' ); ?>
					<br>
					<br>
                </div>
            </div>

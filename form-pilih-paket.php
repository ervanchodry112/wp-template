            ...
            <div class="col-12 col-lg-8">
                ...
                <div class="pf-contactForm mb-5">
                    ...
                    <div class="wpcf7 no-js" id="wpcf7-f1841-o1" lang="en-US" dir="ltr">
                        ...
                        <form action="/form-pilih-paket/#wpcf7-f1841-o1" method="post" class="wpcf7-form init shadow"
                            ...
                            <h6 class="subheading">Step 2 - Bantu Kami Menghubungi Anda
                            </h6>
                            <p class="lead">Isi form di bawah untuk mendapatkan penawaran Sevima Platform yang sesuai
                                dengan kebutuhan perguruan tinggi Anda.
                            </p>
                            <div class="form-group">
                                <p><label for="id:nama-lengkap">Nama Lengkap*</label><br>
                                    <span class="wpcf7-form-control-wrap" data-name="nama-lengkap"><input size="40"
                            ...
                            <div class="form-row">
                                ...
                                <div class="form-group col-md-6">
                                    <p><label for="telp">No Telepon*</label><br>
                                        <span class="wpcf7-form-control-wrap" data-name="telp"><input size="40"
                                                class="wpcf7-form-control wpcf7-text wpcf7-tel wpcf7-validates-as-required wpcf7-validates-as-tel form-control"
                                                id="telp" autocomplete="off" aria-required="true" aria-invalid="false"
                                                value="" type="tel" name="telp"></span>
                                    </p>
                                </div>
                            </div>
                            <div class="form-group">
                                <p><label for="select2-pt">Nama Perguruan Tinggi*</label>
                                    ...
                                    <input class="wpcf7-form-control wpcf7-hidden" id="nama-pt" value="" type="hidden"
                                        name="nama-pt"><span class="wpcf7-form-control-wrap"
                                        data-name="select2-pt"><select
                                            ...
                                            name="select2-pt" data-select2-id="select2-data-select2-pt" tabindex="-1"
                                            aria-hidden="true">
                                            <option value="" data-select2-id="select2-data-2-h7ro">—Please choose an
                                                option—</option>
                                        </select>
                            ...
                            <div class="form-group">
                                <p><label for="inputState">Jabatan di Perguruan Tinggi*</label><br>
                                    <span class="wpcf7-form-control-wrap" data-name="jabatan"><select
                                            class="wpcf7-form-control wpcf7-select wpcf7-validates-as-required wp-select2 select2-hidden-accessible"
                                            ...
                                            aria-hidden="true">
                                            <option value="" data-select2-id="select2-data-4-gk4n"></option>
                                            ...
                                            <option value="Operator &amp; Tim IT Perguruan Tinggi">Operator &amp; Tim IT
                            ...
                            <div class="form-group">
                                <p><label for="select2-jmlmhs">Berapa jumlah mahasiswa di kampus Anda?*</label><br>
                                    <span class="wpcf7-form-control-wrap" data-name="jumlah-mahasiswa"><select
                                            class="wpcf7-form-control wpcf7-select wpcf7-validates-as-required wp-select2"
                            ...
                            <div class="form-group">
                                <p><label for="select2-sumberInfo">Sumber info SEVIMA*</label><br>
                                    <span class="wpcf7-form-control-wrap" data-name="sumberInfo"><select
                                            class="wpcf7-form-control wpcf7-select wpcf7-validates-as-required wp-select2"
                            ...
                            <p><input class="wpcf7-form-control has-spinner wpcf7-submit btn btn-kirim btn-lg btn-block"
                                    type="submit" value="Kirim Permintaan">
                            </p>
                            <p>[send_email]
                            </p>

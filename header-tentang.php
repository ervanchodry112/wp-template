...
<head>
    ...
    <meta property="og:description" content="SEVIMA merupakan perusahaan Education Technology (EdTech) yang menyediakan platform pendidikan untuk perguruan tinggi berbasis layanan Software as a Service (SaaS) dengan lebih dari 750 mitra kampus di Indonesia." />
    <meta property="og:type" content="website" />
    <meta property="og:url" content="https://sevima.com<?php echo $_SERVER['REQUEST_URI']; ?>" />
    <meta property="og:image" content="<?php echo get_template_directory_uri(); ?>/img/og-image-tentang.png" />
            ...
            <nav class="navbar navbar-expand-lg">
                ...
                <div class="collapse navbar-collapse-sevima" id="navbar-sevima">
                    <div class="container navbar-480">
                        ...
                        <div class="navigation-res">
                            ...
                            <a href="https://klikwa.net/sevima">
                ...
                <div class="navbar-right ml-auto hide-xs">
                    ...
                    <div class="icons">
                        ...
                        <a href="https://klikwa.net/sevima" target="_blank"><img src="<?php echo get_template_directory_uri(); ?>/img/whatsapp.png" class="img-fluid gbr-icon" alt=""> </a>
                    </div>
                </div>
            </nav>
        </div>
